...
#ifndef FIRST_SWIFT_APP_SWIFT_H
#define FIRST_SWIFT_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="first_swift_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15first_swift_app11AppDelegate")
...
SWIFT_CLASS("_TtC15first_swift_app14ViewController")
